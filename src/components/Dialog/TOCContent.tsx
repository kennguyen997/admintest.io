  ...
  return (
    <div>
      ...
      <p>
        ...
        personally or on behalf of an entity (“you”) and Terafty ("<b>Company ,</b>" “<b>we,</b>" “
        <b>us,</b>" or “<b>our</b>”), concerning your access to and use of the{' '}
        <a href="https://teraftyfunding.com">https://teraftyfunding.com</a> website as well as any
        other media form, media channel, mobile website or mobile application related, linked, or
        otherwise connected thereto (collectively, the “Site”). We are registered in South Korea and
        have our registered office at G10, 1607, B-dong, 323 Incheon tower-daero, Yeonsu-gu ,
        Incheon , Incheon 22007 . Our VAT number is 1668702503. You agree that by accessing the
      ...
      <p>
        ...
        parental permission to use the Site ; (4) you will not access the Site through automated or
        non-human means, whether through a bot, script, or otherwise; (5) you will not use the Site
      ...
      <p>
        ...
        <a href="https://teraftyfunding.com/pages/contact">
          https://teraftyfunding.com/pages/contact
        </a>
        . By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into
        these Terms of Use. Please be advised the Site is hosted in South Korea . If you access the
        Site from any other region of the world with laws or other requirements governing personal
        data collection, use, or disclosure that differ from applicable laws in South Korea , then
        through your continued use of the Site, you are transferring your data to South Korea , and
        you agree to have your data transferred to and processed in South Korea . Further, we do not
      ...
      <p>
        These Terms shall be governed by and defined following the laws of South Korea . Terafty and
        yourself irrevocably consent that the courts of South Korea shall have exclusive
      ...
      <p>
        ...
        established by this Agreement to the jurisdiction of the South Korea courts. Terafty shall
        also maintain the right to bring proceedings as to the substance of the matter in the courts
        of the country where you reside or, if these Terms are entered into in the course of your
      ...
      <p>
        ...
        THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR $50.00 USD . CERTAIN US STATE LAWS
      ...
      <h3>20.CALIFORNIA USERS AND RESIDENTS</h3>
      <p>
      ...
      <p>
        <b>G10, 1607, B-dong, 323 Incheon tower-daero, Yeonsu-gu</b>
      </p>
      <p>
        <b>Incheon , Incheon 22007</b>
      </p>
      <p>
        <b>South Korea</b>
      </p>
      <p>
        <b>
          Phone: <a href="tel:+821083124096">+82 10 8312 4096</a>
        </b>
      </p>
      <p>
        <b>
          <a href="mailto:cs@terafty.com">cs@terafty.com</a>
        </b>
      </p>
    </div>
  );
