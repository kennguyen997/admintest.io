    ...
    <div>
      ...
      <ul>
        ...
        <li>
          ...
          refers to Terafty, G10, 1607, B-dong, 323 Incheon tower-daero, Yeonsu-gu, Incheon,
        ...
        <li>
          Website refers to Terafty, accessible from{' '}
          <a href="http://www.teraftyfunding.com">http://www.teraftyfunding.com</a>
        </li>
        <li>
      ...
      <ul>
        <li>
          By email: <a href="mailto:cs@terafty.com">cs@terafty.com</a>
        </li>
      </ul>
    </div>
  );
